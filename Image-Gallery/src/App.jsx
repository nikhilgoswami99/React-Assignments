...
import styles from './App.module.css'; // Modular CSS import
    ...
    <div className={styles.imageGalleryContainer}>
      ...
      <div className={styles.imageContainer}>
        {images.map((image, index) => (
          <div key={index} className={styles.imageWrapper} onClick={() => handleClick(image)}>
            <img src={image} alt={`Image ${index + 1}`} className={styles.galleryImage} />
          </div>
        ))}
      </div>
      {selectedImage && (
